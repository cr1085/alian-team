...
$slider_readmore          = get_theme_mod( 'slider_readmore', __( 'Read More', 'relationship-coach' ) );
$button_one               = get_theme_mod( 'button_one', __( 'Get Started', 'relationship-coach' ) );
$button_one_url           = get_theme_mod( 'button_one_url', '#' );
$button_two               = get_theme_mod( 'button_two', __( 'Know More', 'relationship-coach' ) );
...
$banner_title             = get_theme_mod( 'banner_title', __( 'Be The Spark That Lights Up The Room', 'relationship-coach' ) );
$banner_subtitle          = get_theme_mod( 'banner_subtitle', __( 'To empower women to make a positive impact on the world with fiery passion, unbridled self-belief, and head-turning style.', 'relationship-coach' ) );
...
$mobile_img_id            = attachment_url_to_postid( $mobile_header_image);
$cta_static_banner_layout = get_theme_mod( 'cta_static_banner_layout', 'five' );
            ...
            <?php 
                if( wp_is_mobile() && $mobile_header_image ){
                    echo '<div id="wp-custom-header" class="wp-custom-header">' .
                        wp_get_attachment_image( $mobile_img_id, 'full' ) .
                    '</div>';
                } else {
