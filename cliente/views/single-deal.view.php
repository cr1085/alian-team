...
$popup="<style>
       ...
       <script>
        ...
        window.onload = function() {
            ...
            modalContent.innerHTML = '<h2>ATENTO</h2><p>Recomendamos copiar la información del referido, si usted no esta registrado ya que la pagina al recargar le puede borrar dicha información, si el campo esta vacio; puede dejar en blanco el espacio en el área de compra tambien</p> <h3>Refereido asignado:</h3> $user_referido';
...
<div id="myModal" class="modal">
        <div id="modalContent" class="modal-content">
            <!-- El contenido del modal se llenará automáticamente con JavaScript -->
...
<h3 style="font-size:30px;"><?php echo getPrice($itemDetails['deal_oldprice']); ?></h3>
<?php endif; ?>
...
<?php if (isLogged()): ?>
<a href="https://cliente.alianzateamcaribe.com/views/integrador.php?monto=<?php echo getPrice($itemDetails['deal_oldprice']); ?>&detail=<?php  echo echoOutput($itemDetails['deal_title']); ?>&user_referido=<?php echo $user_referido ?>" class="uk-button buybtn_2" uk-toggle>
<?php endif; ?>
...
<?php require './sections/views/exclusive-modal-referido.view.php'; ?>
