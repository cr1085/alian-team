...
<?php if (isLogged()):?>
 <a href="https://alianzateamcaribe.com/views/integrador.php?monto=<?php echo getPrice($itemDetails['deal_price']); ?>&detail=<?php  echo echoOutput($itemDetails['deal_title']); ?>" class="uk-button buybtn_2" uk-toggle>
...
$urlcompartir="http://cliente." . $host . $url;
...
<a href="<?php echo $urlcompartir ?>?email_user=<?php echo $email_user ?>" class="share uk-text-truncate">
