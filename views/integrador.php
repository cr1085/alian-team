...
<form method="POST" action="https://alianzateamcaribe.com/referidos.php?money=<?php echo $money ?>&monto=<?php echo $monto ?>&reference=<?php echo $numeroReferencia ?>&data_signature=<?php echo $dataPayment ?>" style="background:#96CFF5;">
  <div class="form-group">
    <label for="exampleInputEmail1"><span style="color:red;">*</span>Escribe tu email</label>
  ...
  <div class="form-group">
    ...
    <label for="exampleInputPassword1"><span style="color:red;">*</span>Monto</label>
    <input type="text" class="form-control" name="monto"  id="monto" value="<?php echo $monto ?>">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1"><span style="color:red;">*</span>Detalle</label>
    <input type="text" class="form-control" readonly name="detail" id="detail" value="<?php echo $detail ?>" >
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1"><span style="color:red;">*</span>Referencia</label>
  ...
  <div class="form-check">
    ...
    <input type="checkbox" class="form-check-input" id="exampleCheck1" name="checknoreferido">
