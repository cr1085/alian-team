...
<input class="uk-checkbox" type="checkbox" name="ischecked" value="1" required="" style="background:gray; color:black;"> <span class="tas-checkbox-label" style="max-width: 300px"><span class="uk-link"><?php echo echoOutput($translation['tr_155']); ?> <a class="uk-link" href="<?php echo $urlPath->terms(); ?>"> <b><?php echo echoOutput($defaultTermsPage['page_title']); ?></b></a></span></span></label>
</div>
</div>
