...
<div class="uk-container page uk-margin-medium-top">
    ...
    <div class="uk-width-1-2 uk-flex uk-flex-right">
        ...
        <div class="uk-border-rounded" uk-dropdown="mode: click; pos: bottom-justify">
            ...
            <img src="<?php 
            if($item['deal_gif'] != 'Imagen%20de%20WhatsApp%202023-11-09%20a%20las%2014.40.20_fbad8767'){
            echo !empty($item['deal_gif']) ? echoOutput($item['deal_gif']) : $urlPath->image($item['deal_image']);    
            }
            ?>" alt="<?php echo echoOutput($item['deal_title']); ?>" uk-cover>
